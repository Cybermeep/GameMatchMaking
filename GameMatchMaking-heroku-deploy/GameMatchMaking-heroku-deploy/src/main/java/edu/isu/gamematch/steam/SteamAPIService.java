...
public class SteamAPIService {
    ...
    /**
     * Fetches player summary information from Steam API
     * 
     * @param steamId The Steam ID of the user
     * @return SteamUser object with profile data, or null if fetch fails
     */
    ...
    /**
     * Fetches the list of games owned by a user
     * 
     * @param steamId The Steam ID of the user
     * @return List of SteamGame objects, or empty list if fetch fails
     */
    ...
    /**
     * Fetches full user data (profile and games) in one call
     * 
     * @param steamId The Steam ID of the user
     * @return Complete SteamUser object with profile and game data
     */
    ...
    /**
     * Validates the Steam API key by making a test request
     * 
     * @return True if API key is valid
     */
    public boolean validateApiKey() {
        try {
            // Use a known public Steam ID for testing (Valve's ID)
